...
impl Ticket {
    pub fn new(title: String, description: String, status: String) -> Ticket {
        Ticket::title_validations(&title);
        Ticket::description_validations(&description);
        Ticket::status_validations(&status);
    ...
    fn title_validations(title: &String) {
        if title.is_empty() {
    ...
    fn description_validations(description: &String) {
    ...
    fn status_validations(status: &String) {
